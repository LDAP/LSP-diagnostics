...
from .diagnostics import _generate_line_stacks, _generate_blocks, generate_region_html_content, sort_diagnostics
...
class DiagnosticCommand(sublime_plugin.TextCommand):
	def run(self, _: sublime.Edit) -> None:
		...
		for region in blocks:
			...
			make_phantom.append(sublime.Phantom(sublime.Region(28, 28), content, sublime.LAYOUT_BELOW))
